    ...
    *********************************************************************************************************************************************************** -->
    ...
    <div id="main">
        <ul class="nav nav-tabs" style="margin: 20px 20px 0;">
            ...
            <li role="presentation" class="active"><a href="<?php echo U('user/paycheck');?>">充值记录</a></li>
            <li role="presentation"><a href="<?php echo U('user/consume');?>">消费记录</a></li>
        </ul>
        <div class="col-lg-12">
            <div class="col-lg-12" style="margin: 40px 0 20px;">
                <form class="form-inline" action="<?php echo U('user/paycheck');?>" method="get">
            ...
            <div class="col-lg-12 mt">
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr id="tr-<?php echo ($vo["id"]); ?>">
                            ...
                            <td>
                                <?php if(($vo["state"]) == "0"): ?><button class="btn btn-danger" disabled>未支付</button>
                                    <?php else: ?>
                                    <button class="btn btn-success" disabled>已支付</button><?php endif; ?>
                            </td>
                            <td>
                                <?php if(($_SESSION['admin_role']) == "0"): ?><i class="glyphicon glyphicon-trash pointer" onclick="doDel('<?php echo ($vo["id"]); ?>')"></i>
                                    <?php else: ?>
                                    --<?php endif; ?>
                            </td>
