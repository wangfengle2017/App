    ...
    *********************************************************************************************************************************************************** -->
    ...
    <div id="main">
        <ul class="nav nav-tabs" style="margin: 20px 20px 0;">
            <li role="presentation"><a href="<?php echo U('equip/index');?>">设备信息</a></li>
            <li role="presentation"><a href="<?php echo U('equip/use_equip');?>">使用日志</a></li>
            <li role="presentation" class="active"><a href="<?php echo U('equip/equip_log');?>">故障日志</a></li>
        </ul>
        <div class="col-lg-12">
            <div class="col-lg-12" style="margin: 40px 0 20px;">
                <form class="form-inline" action="<?php echo U('equip/equip_log');?>" method="post">
