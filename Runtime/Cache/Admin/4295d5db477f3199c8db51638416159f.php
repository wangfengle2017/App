    ...
    *********************************************************************************************************************************************************** -->
    ...
    <div id="main">
        <ul class="nav nav-tabs" style="margin: 20px 20px 0;">
            <li role="presentation" class="active"><a href="<?php echo U('user/index');?>">用户信息</a></li>
        ...
        <div class="col-lg-12">
            <div class="col-lg-12" style="margin: 40px 0 20px;">
                <form class="form-inline" action="<?php echo U('user/index');?>" method="post">
